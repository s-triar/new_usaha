...
{
    /// <inheritdoc />
    public partial class make_icollection_virtual : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoodsContainers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GoodsContainers_Enterprises_EnterpriseId",
                        column: x => x.EnterpriseId,
                        principalTable: "Enterprises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodsContainers_GoodsTypes_GoodsTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Goodses_GoodsContainerId",
                table: "Goodses",
                column: "GoodsContainerId");

            migrationBuilder.CreateIndex(
                name: "IX_GoodsContainers_EnterpriseId",
                table: "GoodsContainers",
                column: "EnterpriseId");

            migrationBuilder.CreateIndex(
                name: "IX_GoodsContainers_GoodsTypeId",
                table: "GoodsContainers",
                column: "GoodsTypeId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Goodses_GoodsContainers_GoodsContainerId",
                table: "Goodses",
                column: "GoodsContainerId",
                principalTable: "GoodsContainers",
                principalColumn: "Id",
                onDelete: ReferentialAction.Cascade);
