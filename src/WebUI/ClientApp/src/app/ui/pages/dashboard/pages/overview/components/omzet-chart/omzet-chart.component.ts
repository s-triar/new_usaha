...
import { ResultOmzetLineDiagram, ResultOmzetLineDiagramItem } from 'src/app/domain/backend/Dtos';
  ...
  ngOnInit(): void {
    ...
    this.form.valueChanges
        .pipe(
          ...
          switchMap((x:GetOmzetQuery)=> this._myenterpriseService.GetOmzetMyEnterprise(x))
          
        )
        .subscribe(
          (x:ResultOmzetLineDiagram) =>{
