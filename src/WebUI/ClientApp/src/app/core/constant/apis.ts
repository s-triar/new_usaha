...
export const GoodsGroupAPI = {
    Create: `${prefixApi}/MyGoodsGroup/Create`, // POST
    GetMyGoodsGroup: `${prefixApi}/MyGoodsGroup/GetMyGoodsGroups`, // GET
    CheckDuplicateGoodsGroupName: `${prefixApi}/MyGoodsGroup/CheckDuplicateGoodsGroupName` // GET
};
