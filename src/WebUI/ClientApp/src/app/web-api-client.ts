...
export interface IAccountClient {
    ...
    register(command: RegisterAnUserCommand): Observable<Unit>;
    checkDuplicateEmail(email: string | null | undefined): Observable<boolean>;
    checkDuplicatePhone(phone: string | null | undefined): Observable<boolean>;
}
...
export class AccountClient implements IAccountClient {
    ...
    protected processRegister(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    checkDuplicateEmail(email: string | null | undefined): Observable<boolean> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckDuplicateEmail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckDuplicateEmail(response_ as any);
                } catch (e) {
    ...
    protected processCheckDuplicateEmail(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    checkDuplicatePhone(phone: string | null | undefined): Observable<boolean> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckDuplicatePhone(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckDuplicatePhone(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<boolean>;
                }
            } else
    ...
    protected processCheckDuplicatePhone(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IEmployeeClient {
    ...
    createEmployee(command: CreateEmployeeCommand): Observable<Unit>;
    updateEmployee(command: UpdateEmployeeCommand): Observable<Unit>;
    deleteEmployee(command: DeleteEmployeeCommand): Observable<Unit>;
    joinEmployee(command: JoinEmployeeCommand): Observable<Unit>;
}
...
export class EmployeeClient implements IEmployeeClient {
    ...
    protected processCreateEmployee(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processUpdateEmployee(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processDeleteEmployee(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processJoinEmployee(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IGoodsClient {
    ...
    getInfoOfGoodsForUpdating(id: string | undefined): Observable<MyGoodsInfoDto>;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<MyGoodsInfoDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<MyGoodsInfoDto>;
        }));
    }

    protected processGetInfoOfGoodsForUpdating(response: HttpResponseBase): Observable<MyGoodsInfoDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IMyEnterpriseClient {
    ...
    getOmzetMyEnterprise(year: number | undefined): Observable<ResultOmzetLineDiagram>;
}

@Injectable({
    providedIn: 'root'
})
export class MyEnterpriseClient implements IMyEnterpriseClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<SearchPageResponseOfMyEnterpriseDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SearchPageResponseOfMyEnterpriseDto>;
        }));
    }

    protected processGetOwned(response: HttpResponseBase): Observable<SearchPageResponseOfMyEnterpriseDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getOmzetMyEnterprise(year: number | undefined): Observable<ResultOmzetLineDiagram> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetOmzetMyEnterprise(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetOmzetMyEnterprise(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ResultOmzetLineDiagram>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ResultOmzetLineDiagram>;
        }));
    }

    protected processGetOmzetMyEnterprise(response: HttpResponseBase): Observable<ResultOmzetLineDiagram> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class MyGoodsClient implements IMyGoodsClient {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processUpdateSellingPrice(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processAddStock(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processAdjustStock(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getListProductSellPrice(id: string | undefined, year: number | undefined, type: DiagramRangeSellPriceType | undefined): Observable<ResultSellPriceLineDiagram> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetListProductSellPrice(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetListProductSellPrice(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ResultSellPriceLineDiagram>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ResultSellPriceLineDiagram>;
        }));
    }

    protected processGetListProductSellPrice(response: HttpResponseBase): Observable<ResultSellPriceLineDiagram> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getListProductBuyPrice(id: string | undefined, year: number | undefined, type: DiagramRangeBuyPriceType | undefined): Observable<ResultBuyPriceLineDiagram> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetListProductBuyPrice(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetListProductBuyPrice(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ResultBuyPriceLineDiagram>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ResultBuyPriceLineDiagram>;
        }));
    }

    protected processGetListProductBuyPrice(response: HttpResponseBase): Observable<ResultBuyPriceLineDiagram> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getListProductNSold(id: string | undefined, year: number | undefined, type: DiagramRangeSoldType | undefined): Observable<ResultSoldLineDiagram> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetListProductNSold(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetListProductNSold(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ResultSoldLineDiagram>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ResultSoldLineDiagram>;
        }));
    }

    protected processGetListProductNSold(response: HttpResponseBase): Observable<ResultSoldLineDiagram> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IMyGoodsGroupClient {
    ...
    create(command: CreateGoodsGroupCommand): Observable<Unit>;
}

@Injectable({
    providedIn: 'root'
})
export class MyGoodsGroupClient implements IMyGoodsGroupClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export interface IOrderClient {
    ...
    createOrderCashier(total: number | undefined, payment: number | undefined, return: number | undefined, to: string | null | undefined, items: ItemOrdered[] | null | undefined): Observable<CreateOrderCashierCommandResponse>;
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CreateOrderCashierCommandResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CreateOrderCashierCommandResponse>;
        }));
    }

    protected processCreateOrderCashier(response: HttpResponseBase): Observable<CreateOrderCashierCommandResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IRoleClient {
    ...
    createRole(command: CreateRoleCommand): Observable<Unit>;
    updateRole(command: UpdateRoleCommand): Observable<string>;
    deleteRole(command: DeleteRoleCommand): Observable<string>;
}
...
export class RoleClient implements IRoleClient {
    ...
    protected processCreateRole(response: HttpResponseBase): Observable<Unit> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
